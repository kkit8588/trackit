    ...
    <main class="content px-4 pt-4 pe-lg-5">
        ...
        <div class="bottom shadow mt-2">
            <table class="table table-sm table-bordered table-responsive table-hover text-center">
                ...
                <tbody class="reporttable table-group-divider border-secondary-subtle">
          ...
          <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                <span><b>DID YOU PASS THE ASSESSMENT:&nbsp;</b><p id="statustxt"></p></span>
                ...
                <span><b>If employed: number of months/yrs in work:&nbsp;</b><p id="q7txt"></p></span>
